/*
      ...
      nRF51 with SoftDevice: IRQ 1, 3 allowed
      nRF51 w/o SoftDevice IRQ < 4 allowed

      See also NRFX_IRQ_PRIORITY_SET(irq_number, priority) in nrfx_glue.h
*/

/*
      What is the difference between nrfx_config.h and sdk_config.h?
      https://devzone.nordicsemi.com/f/nordic-q-a/39914/what-is-the-difference-between-nrfx_config-h-and-sdk_config-h/154874#154874
*/

/*
      Which hardware is available?
      See: SDK documentation nRF5 SDK v15.3.0 > Hardware Drivers > Driver support matrix
      See: nrf51822_peripherals.h
*/
